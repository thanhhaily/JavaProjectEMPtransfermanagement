...
public class frmRequestTransfer extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnOneToRight = new javax.swing.JButton();
        btnAllToRight = new javax.swing.JButton();
        btnOneToLeft = new javax.swing.JButton();
        btnAllToLeft = new javax.swing.JButton();
        ...
        jLabel10.setText("List of Employee:");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGap(110, 301, Short.MAX_VALUE)
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Result", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N

        jScrollPane2.setViewportView(lstRight);

        jScrollPane1.setViewportView(lstLeft);

        btnOneToRight.setText(">");
        btnOneToRight.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnOneToRightActionPerformed(evt);
            }
        });

        btnAllToRight.setText(">>");
        btnAllToRight.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAllToRightActionPerformed(evt);
            }
        });

        btnOneToLeft.setText("<");
        btnOneToLeft.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnOneToLeftActionPerformed(evt);
            }
        });

        btnAllToLeft.setText("<<");
        btnAllToLeft.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAllToLeftActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(btnAllToLeft, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnOneToLeft, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnAllToRight, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnOneToRight, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 47, Short.MAX_VALUE)
                        .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE))
                    .addComponent(btnRequestMulti, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnApprovalMulti, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnOneToRight)
                        .addGap(18, 18, 18)
                        .addComponent(btnAllToRight)
                        .addGap(18, 18, 18)
                        .addComponent(btnOneToLeft)
                        .addGap(18, 18, 18)
                        .addComponent(btnAllToLeft)
                        .addGap(0, 0, Short.MAX_VALUE))
    ...
    private void btnOneToRightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOneToRightActionPerformed
    ...
    }//GEN-LAST:event_btnOneToRightActionPerformed

    private void btnAllToRightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAllToRightActionPerformed
        // Copy all elements form Left to Right
        for (int i = 0; i < listLeft.getSize(); i++) {
            listRight.addElement(listLeft.elementAt(i));
        }

        // Remove all elements
        listLeft.removeAllElements();
    }//GEN-LAST:event_btnAllToRightActionPerformed

    private void btnOneToLeftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOneToLeftActionPerformed
        int[] fromIndex = lstRight.getSelectedIndices();
        Object[] from = lstRight.getSelectedValues();

        // Add elements from right List to left List
        for (int i = 0; i < from.length; i++) {
            listLeft.addElement(from[i]);
        }

        // Remove selected element
        for (int i = (fromIndex.length - 1); i >= 0; i--) {
            listRight.remove(fromIndex[i]);
        }
    }//GEN-LAST:event_btnOneToLeftActionPerformed

    private void btnAllToLeftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAllToLeftActionPerformed
        // Copy all elements form Right to Left
        for (int i = 0; i < listRight.getSize(); i++) {
            listLeft.addElement(listRight.elementAt(i));
        }

        // Remove all elements
        listRight.removeAllElements();
    }//GEN-LAST:event_btnAllToLeftActionPerformed
        ...
        if (fromIndex.length == 0) {
            ...
            try {
                ...
                if (fromDateToRequest != null || toDateToRequest != null) {
                    ...
                    for (int e : fromIndex) {
                        String selectedItemInList = lstRight.getModel().getElementAt(e);
                        ...
                        if (transferObj.getCurrentProjectIdOfEmp(selectedItemInList) != null) {
                            if (transferObj.getCurrentProjectIdOfEmp(selectedItemInList).equals((String) cbxToProjectMulti.getSelectedItem())) {
                                JOptionPane.showMessageDialog(this, "The employee is currently working in this project, choose another one.");
                            }
                ...
                if (fromDateToRequest != null || toDateToRequest != null) {
                    ...
                    for (int e : fromIndex) {
                        ...
                        if (transferObj.getCurrentProjectIdOfEmp(selectedItemInList) != null) {
                            ...
                            transferToAdd.setFromProjectId(transferObj.getCurrentProjectIdOfEmp(selectedItemInList));
                            transferToAdd.setToProjectId((String) cbxToProjectMulti.getSelectedItem());
                            transferToAdd.setStatus("Approved");
    ...
    private javax.swing.JButton btnAllToLeft;
    private javax.swing.JButton btnAllToRight;
    private javax.swing.JButton btnApprovalMulti;
    private javax.swing.JButton btnCancel;
    private javax.swing.JButton btnGO;
    private javax.swing.JButton btnOneToLeft;
    private javax.swing.JButton btnOneToRight;
